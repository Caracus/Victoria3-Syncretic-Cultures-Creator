...
fun createLocalization(syncreticCultures: List<SyncreticCulture>) {
        ...
        localizations.forEach { localization ->
                ...
                syncreticCultures.forEach {
                        ...
                        text += format(0," je_standardize_${cultureNameKey}:0 \"Standardize ${cultureNameLocalization}\"" ,1)
                        ...
                        text += format(0," standardize_${cultureNameKey}.5.t:0 \"Yearly graduation\"" ,1)
